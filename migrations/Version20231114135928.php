 ...
 */
final class Version20231114135928 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ADD slug VARCHAR(125) NOT NULL');
        $this->addSql('ALTER TABLE book ADD image VARCHAR(125) NOT NULL');
